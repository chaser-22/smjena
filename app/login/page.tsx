...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f4f1eb] px-4 py-8 text-[#101d34] sm:py-14">
      ...
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[34px] border border-black/10 bg-white shadow-2xl shadow-[#101d34]/10 lg:grid-cols-[1.05fr_.95fr]">
        <section className="relative overflow-hidden bg-[#101d34] p-8 text-white sm:p-12">
          ...
          <div className="relative">
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-white/60">SMJENA povezuje provjerene radnike i poslodavce u Crnoj Gori—sa jasnom cijenom, evidencijom dolaska i pouzdanošću koja se gradi svakim završenim poslom.</p>
