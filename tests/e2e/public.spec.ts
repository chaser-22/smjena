...
test('application and employer routes require login and preserve their destination', async ({ page }) => {
  for (const path of ['/applications', '/applications?filter=offered&page=9', '/employer/billing', '/employer/billing?workspace=10000000-0000-4000-8000-000000000001', '/employer/shifts', '/employer/shifts/10000000-0000-4000-8000-000000000001/applications']) {
    await page.goto(path);
    await expect(page.getByRole('heading', { name: 'Dobro došao nazad.' })).toBeVisible();
